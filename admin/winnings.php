...
<div id="wrapper">
	...
	<div id="rightContent">
	<h3>Questions</h3>
	<input type="text" id="winnername" class="sedang">
	<input type="button" class="button" id="winnerbut" value="search for winnings by name"/>
		<table class="data">
			<tr class="data">
				<th class="data" width="30px">No</th>
				<th class="data">Name</th>
				<th class="data">Phone</th>
				<th class="data" width="75px">Code</th>
...
$query = "SELECT * FROM gaming WHERE winner='1' LIMIT $lim1,$display";
...
?>
		...
		<div class="page">
		<?php
$query = "SELECT count(gid) AS counts FROM gaming WHERE winner='1'";
$result = mysql_query($query);
...
echo "<a class='$class' href='winnings.php?lim1=$lim1&viewing=$no'>$no</a>" ;
...
echo "<a class='$class' href='winnings.php?lim1=$a&viewing=$no'>$no</a>" ;
?>
	    </div>
	</div>
<div class="clear"></div>
