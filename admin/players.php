...
<div id="wrapper">
	...
	<div id="rightContent">
	<h3>Players Info</h3>
	<input type="text" id="searchPlayer" class="sedang">
	<input type="button" class="button" id="playerbutton" value="Search Players"/>
		<table class="data">
			<tr class="data">
				<th class="data" width="30px">S/N</th>
...
$query = "SELECT * FROM users LIMIT $lim1,$display";
...
?>
		...
		<div class="page">
		<?php
$query = "SELECT count(id) AS counts FROM users";
$result = mysql_query($query);
...
echo "<a class='$class' href='players.php?lim1=$lim1&viewing=$no'>$no</a>" ;
...
echo "<a class='$class' href='players.php?lim1=$a&viewing=$no'>$no</a>" ;
?>
	    </div>
	</div>
<div class="clear"></div>
